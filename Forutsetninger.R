...
swap_y.rc_1 <- 3.98          # Oppdatert 03.10.25 HBHO 
kreditpremie_y.rc_1 <- 0.88  # Oppdatert 08.10.25 HBHO
 
# Rente for inntektsrammeaaret (t)
swap_y.rc <- 3.98            # Oppdatert 03.10.25 HBHO
kreditpremie_y.rc <- 0.84   # Oppdatert 08.10.25 HBHO
